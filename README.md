...
searches by walking `refers_to`/[`cites`](https://vedicreader.github.io/vruksha/entities.html#cites)/`builds_on` edges fused with hybrid.
...
Priming stops most duplicates; [`resolve_entities`](https://vedicreader.github.io/vruksha/build.html#resolve_entities) merges the rest. Embedding similarity alone
merges `python 3.11` into `python 3.12`, so every merge passes [`_lex_ok`](https://vedicreader.github.io/vruksha/entities.html#_lex_ok) first: token overlap or a
